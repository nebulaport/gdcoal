...
public class TFultbsupplierEntity extends BaseEntity {
    ...
    private Date clicklogintime;

    private Date nclicklogintime;
    ...
    private BigDecimal minespecialcost;

    private BigDecimal railcarriage;
    ...
    public Date getClicklogintime() {
        return clicklogintime;
    }

    public void setClicklogintime(Date clicklogintime) {
        this.clicklogintime = clicklogintime;
    }

    public Date getNclicklogintime() {
        return nclicklogintime;
    }

    public void setNclicklogintime(Date nclicklogintime) {
    ...
    public BigDecimal getMinespecialcost() {
        return minespecialcost;
    }

    public void setMinespecialcost(BigDecimal minespecialcost) {
        this.minespecialcost = minespecialcost;
    }

    public BigDecimal getRailcarriage() {
        return railcarriage;
    }

    public void setRailcarriage(BigDecimal railcarriage) {
