        ...
        $(document).ready(function() {
            ...
            $("#saveBtn").click(function(){
                if( $("#addRoleForm").data('bootstrapValidator').isValid()){
                    ...
                    $.ajax({
                        url:"<%=basePath%>sys/saveRoleValidate",
                        data:{roleName:roleName},
                        dataType:"json",
                        type:"post",
                        success:function(res){
                            if(res){
                                $("#addRoleForm")[0].submit();
                            }else{
                                alert("角色已经存在！");
                            }
                        },error:function(){
...
<div class="panel panel-default">
    <div class="panel-heading" style="background-color:#052963">
        <h2 class="panel-title" style="font-weight:bold; color:#fff;">
            系统信息管理-<span style="font-size:14px;">角色信息添加</span>
        </h2>
    </div>
    <div class="panel-body">
        <form class="form-inline" action="<%=basePath%>sys/saveRole" method="post" id="addRoleForm">
            <div class="formRow">
                <div class="form-group">
                    <label for="roleName">角色名称</label>
                    <input type="text" id="roleName" required name="roleName" data-bv-notempty-message="请输入名称" class="form-control" id="roleName" placeholder="输入名称">
                </div>
            </div>
